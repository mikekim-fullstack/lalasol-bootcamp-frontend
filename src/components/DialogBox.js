...
function DialogBox({ dialogData, onDialog, backgroundColor }) {

    return (
        <div style={{ backgroundColor: backgroundColor }} className='dialogbox__view' onClick={() => onDialog(false, dialogData)} >
