            ...
            <div className={`add_chapter__component`}>
                <div className='chapters_view'>
                    ...
                    <div className='title'>
                        ...
                        <div>Build Chapter for <span className='t2'>{clickedCourse?.course?.title}</span> Course</div>
                    </div>
                    <div className='svg_icon'>
                        ...
                        {/* //close add - sign  */}
                        {!operateChapter && <svg onClick={e => handleClickCloseChapter(e,)} xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M5.25 12.75v-1.5h13.5v1.5Z" /></svg>}

                        {/* //add expend + sign */}
                        {operateChapter && <svg onClick={e => handleAddChapter(e,)} xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M11.25 16.75h1.5v-4h4v-1.5h-4v-4h-1.5v4h-4v1.5h4ZM5.3 20.5q-.75 0-1.275-.525Q3.5 19.45 3.5 18.7V5.3q0-.75.525-1.275Q4.55 3.5 5.3 3.5h13.4q.75 0 1.275.525.525.525.525 1.275v13.4q0 .75-.525 1.275-.525.525-1.275.525Zm0-1.5h13.4q.1 0 .2-.1t.1-.2V5.3q0-.1-.1-.2t-.2-.1H5.3q-.1 0-.2.1t-.1.2v13.4q0 .1.1.2t.2.1ZM5 5v14V5Z" /></svg>}
