        ...
        <nav className='nav__header'>
            <div className='nav__container'>
                ...
                <div className='nav__user'>
                    ...
                    <button className='btn_user_profile' style={user.role == 'teacher' ? { backgroundColor: 'rgb(255,90,0)' } : { backgroundColor: 'rgb(0,90,255)' }} onClick={handleLogout}>{user && `${user?.first_name[0]?.toUpperCase()}${user?.last_name[0]?.toUpperCase()}`}</button>
                </div>
